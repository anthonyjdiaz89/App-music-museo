...
export const PlayerProgressBar: React.FC<PlayerProgressBarProps> = ({ position, duration, onSeek }) => {
    ...
    <View style={styles.progressContainer}>
      ...
      <View
        ...
        onResponderMove={(e) => {
          ...
          handleSeekFromX(locationX, e.currentTarget?.clientWidth || duration || 1);
        }}
      >
